 ...
 * Use the [DeleteBottomSheetFragment.newInstance] factory method to
...
class DeleteBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DeleteBottomSheetFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DeleteBottomSheetFragment().apply {
